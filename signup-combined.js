        ...
        try {
          ...
          if (result.success) {
            ...
            setTimeout(() => {
              ...
              // The original code had submitButton.disabled = false; but submitButton was not defined.
              // Assuming it was meant to be the button element itself.
              // Since the button is a span, we'll just reset the text content.
              // If the intent was to re-enable the button, it would need to be a button element.
              // For now, removing the line as it's not directly applicable to a span.
            }, 3000);
          }
        } catch (error) {
