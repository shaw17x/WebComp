  ...
  <div class="auth-screen-card">
    ...
    <div class="auth-header">
      ...
      <div style="display: inline-flex; align-items: center; gap: 0; margin-bottom: 0.5rem;">
        <img src="https://raw.githubusercontent.com/shaw17x/WebComp/main/SteleyBlueLogo.png?v=2" alt="Steley Logo" style="width: 40px; height: 40px; object-fit: contain; image-rendering: crisp-edges; flex-shrink: 0; margin-right: 0px;" onerror="console.warn('Steley logo failed to load'); this.style.display='none'">
