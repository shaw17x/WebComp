// Steley Documentation Combined - CSS + HTML Content
const docsCSS = `
...
<div class="docs-page">
  <div style="text-align: center;">
    <div class="docs-badge">
      ...
      Steley Product Story
    </div>
  </div>
  <h1 class="docs-title">Why Steley Exists</h1>
  ...
  <div class="docs-section docs-intro">
    <p>Steley was born from a fundamental understanding: the current assessment system is broken. In today's competitive landscape, talented individuals often fail interviews, exams, tests, quizzes, and certifications not due to lack of capability, but because of anxiety, unfair assessment methods, and biased evaluation systems. We built Steley to level the playing field across all forms of evaluation.</p>
  </div>
  ...
  <div class="docs-section">
    ...
    <p>Steley exists to democratize access to educational and career opportunities by creating fairer assessment systems across all evaluation formats.</p>
  ...
  <div class="docs-section">
    ...
    <p>Steley addresses these challenges through innovative technology and principled design decisions.</p>
  ...
  <div class="docs-section">
    ...
    <p>Steley represents the beginning of a broader transformation in how we evaluate knowledge, skills, and competency across all assessment formats.</p>
...
(function() {
  // Check if documentation is already loaded to prevent duplication
  if (document.querySelector('.docs-page') || document.querySelector('[data-steley-docs-loaded]')) {
    return; // Already loaded, prevent duplication
  }

  // Mark as loaded
  document.documentElement.setAttribute('data-steley-docs-loaded', 'true');

  // Add CSS (check if already exists)
  if (!document.querySelector('style[data-steley-docs-css]')) {
    const style = document.createElement('style');
    style.setAttribute('data-steley-docs-css', 'true');
