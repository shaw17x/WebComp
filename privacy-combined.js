...
.footer-row{display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:40px;animation:fadeInUp 0.8s cubic-bezier(0.25,0.46,0.45,0.94) 0.2s both}
...
.footer-legal{display:flex;gap:32px;align-items:center}
