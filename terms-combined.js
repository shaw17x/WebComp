...
.tos-badge{display:inline-flex;align-items:center;gap:8px;background-color:rgba(107,114,128,0.1);border:1px solid rgba(107,114,128,0.3);border-radius:20px;padding:6px 16px;margin-bottom:16px;font-size:12px;font-weight:500;color:#9ca3af;text-transform:uppercase;letter-spacing:1px;animation:badgeEntry 0.8s cubic-bezier(0.25,0.46,0.45,0.94) 0.1s both;position:relative;z-index:1000}
.tos-badge-dot{width:6px;height:6px;border-radius:50%;background-color:#6b7280;animation:spin 3s linear infinite}
.tos-title{font-size:3rem;font-weight:800;background:linear-gradient(135deg,#fff 0%,#9ca3af 50%,#6b7280 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;text-align:center;margin-bottom:40px;position:relative;z-index:1000}
...
.tos-section{background:linear-gradient(135deg,rgba(107,114,128,0.6),rgba(156,163,175,0.3));backdrop-filter:blur(10px);border:1px solid rgba(107,114,128,0.1);border-radius:20px;padding:30px;margin-bottom:30px;transition:all 0.3s cubic-bezier(0.4,0,0.2,1);position:relative;z-index:1000}
.tos-section:hover{transform:translateY(-5px);border-color:rgba(107,114,128,0.3);box-shadow:0 20px 40px rgba(107,114,128,0.1)}
...
.tos-intro{background:linear-gradient(135deg,rgba(107,114,128,0.1),rgba(156,163,175,0.05));border:1px solid rgba(107,114,128,0.2);text-align:center}
.tos-contact{background:linear-gradient(135deg,rgba(107,114,128,0.1),rgba(156,163,175,0.05));border:1px solid rgba(107,114,128,0.2)}
...
.tos-important{background:linear-gradient(135deg,rgba(107,114,128,0.1),rgba(156,163,175,0.05));border:1px solid rgba(107,114,128,0.2)}
...
.tos-important:hover{border-color:rgba(107,114,128,0.3);box-shadow:0 20px 40px rgba(107,114,128,0.1)}
.tos-contact:hover{border-color:rgba(107,114,128,0.3);box-shadow:0 20px 40px rgba(107,114,128,0.1)}
