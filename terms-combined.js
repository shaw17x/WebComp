...
.tos-section{background:#0a0e1a;backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,0.1);border-radius:20px;padding:30px;margin-bottom:30px;transition:all 0.3s cubic-bezier(0.4,0,0.2,1);position:relative;z-index:1000}
.tos-section:hover{transform:translateY(-5px);border-color:rgba(255,255,255,0.2);box-shadow:0 20px 40px rgba(10,14,26,0.3)}
...
.tos-important:hover{border-color:rgba(255,255,255,0.2);box-shadow:0 20px 40px rgba(10,14,26,0.3)}
.tos-contact:hover{border-color:rgba(255,255,255,0.2);box-shadow:0 20px 40px rgba(10,14,26,0.3)}
