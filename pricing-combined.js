...
.plans-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:30px;margin-bottom:80px}
.plan-card{background:linear-gradient(135deg,rgba(15,23,42,0.6),rgba(30,41,59,0.3));backdrop-filter:blur(10px);border:1px solid rgba(99,102,241,0.1);border-radius:20px;padding:30px;margin-bottom:30px;transition:all 0.3s ease;position:relative;z-index:1000}
.plan-card:hover{transform:translateY(-5px);border-color:rgba(99,102,241,0.3);box-shadow:0 20px 40px rgba(99,102,241,0.1)}
.plan-card.popular{border:1px solid rgba(139,92,246,0.2);background:linear-gradient(135deg,rgba(139,92,246,0.1),rgba(236,72,153,0.05))}
.popular-badge{background:linear-gradient(135deg,#8b5cf6,#ec4899);color:#fff;padding:8px 20px;border-radius:20px;font-size:0.8rem;font-weight:600;margin-bottom:15px;display:inline-block;position:relative;z-index:1001}
.plan-name{color:#fff;font-size:1.5rem;font-weight:700;margin-bottom:15px;position:relative;z-index:1001}
.plan-price{color:#fff;font-size:3rem;font-weight:800;margin-bottom:5px;position:relative;z-index:1001}
.plan-period{color:#94a3b8;font-size:1rem;margin-bottom:20px;position:relative;z-index:1001}
.plan-description{color:#cbd5e1;font-size:1rem;line-height:1.6;margin-bottom:15px;position:relative;z-index:1001}
.plan-features{list-style:none;padding:0;margin:15px 0;position:relative;z-index:1001}
...
.plan-features li::before{content:'✓';position:absolute;left:0;color:#10b981;font-weight:bold;z-index:1002}
.plan-button{width:100%;padding:15px 30px;border:none;border-radius:12px;font-size:1rem;font-weight:600;cursor:pointer;transition:all 0.3s ease;text-decoration:none;display:inline-block;text-align:center;position:relative;z-index:1001}
.plan-button.primary{background:linear-gradient(135deg,#6366f1,#8b5cf6);color:#fff}
.plan-button.primary:hover{background:linear-gradient(135deg,#5855eb,#7c3aed);transform:translateY(-2px)}
.plan-button.secondary{background:transparent;color:#6366f1;border:2px solid #6366f1}
.plan-button.secondary:hover{background:#6366f1;color:#fff}
.faq-section{margin-top:80px;position:relative;z-index:1000}
.faq-title{font-size:2.5rem;font-weight:700;text-align:center;margin-bottom:50px;background:linear-gradient(135deg,#fff 0%,#6366f1 50%,#8b5cf6 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
.faq-item{border-bottom:1px solid rgba(255,255,255,0.1)}
.faq-button{width:100%;padding:32px 0;background:transparent;border:none;display:flex;justify-content:space-between;align-items:center;cursor:pointer;transition:all 0.3s ease;color:#fff;font-size:1.2rem;font-weight:500;text-align:left}
.faq-button:hover{transform:translateX(8px)}
.faq-question{padding-right:20px;line-height:1.4}
.faq-icon{width:24px;height:24px;display:flex;align-items:center;justify-content:center;transition:transform 0.3s ease;flex-shrink:0}
.faq-icon.open{transform:rotate(45deg)}
.faq-answer{overflow:hidden;transition:all 0.4s cubic-bezier(0.25,0.46,0.45,0.94);max-height:0;opacity:0}
.faq-answer.open{max-height:500px;opacity:1}
.faq-answer-content{padding-bottom:32px;padding-right:44px}
.faq-answer-text{font-size:1rem;color:rgba(255,255,255,0.7);line-height:1.6;margin:0}
      ...
      <div class="faq-list">
        <div class="faq-item">
          ...
          <div class="faq-answer" id="answer-0">
            <div class="faq-answer-content">
              <p class="faq-answer-text">The Free plan includes 10 AI queries per month, basic screenshot analysis, standard response time, community support, and basic templates. Perfect for getting started with Ghost Pilot.</p>
            </div>
          </div>
        </div>
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer" id="answer-1">
            <div class="faq-answer-content">
              <p class="faq-answer-text">Yes, you can upgrade or downgrade your subscription at any time. Changes take effect immediately for upgrades, and at the end of your billing cycle for downgrades.</p>
            </div>
          </div>
        </div>
      </div>
