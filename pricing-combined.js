...
.pricing-card.featured::before{content:'MOST POPULAR';position:absolute;top:-12px;right:20px;background:linear-gradient(135deg,#6366f1 0%,#8b5cf6 50%,#a855f7 100%);color:#fff;font-size:11px;font-weight:800;padding:8px 16px;border-radius:25px;letter-spacing:0.8px;box-shadow:0 4px 20px rgba(139,92,246,0.4),0 2px 8px rgba(0,0,0,0.2);border:2px solid rgba(255,255,255,0.2);transform:translateY(0);transition:all 0.3s ease;z-index:1010}
.pricing-card.featured:hover::before{transform:translateY(-2px) scale(1.05);box-shadow:0 8px 30px rgba(139,92,246,0.6),0 4px 15px rgba(0,0,0,0.3)}
.pricing-card.best-value::before{content:'BEST VALUE';position:absolute;top:-12px;right:20px;background:linear-gradient(135deg,#10b981 0%,#14b8a6 50%,#06b6d4 100%);color:#fff;font-size:11px;font-weight:800;padding:8px 16px;border-radius:25px;letter-spacing:0.8px;box-shadow:0 4px 20px rgba(20,184,166,0.4),0 2px 8px rgba(0,0,0,0.2);border:2px solid rgba(255,255,255,0.2);transform:translateY(0);transition:all 0.3s ease;z-index:1010}
.pricing-card.best-value:hover::before{transform:translateY(-2px) scale(1.05);box-shadow:0 8px 30px rgba(20,184,166,0.6),0 4px 15px rgba(0,0,0,0.3)}
