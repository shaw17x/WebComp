...
.pricing-card.featured::before{content:'MOST POPULAR';position:absolute;top:-12px;right:20px;background:linear-gradient(135deg,rgba(88,28,135,0.9) 0%,rgba(124,58,237,0.8) 50%,rgba(139,92,246,0.9) 100%);backdrop-filter:blur(12px);color:#fff;font-size:11px;font-weight:800;padding:8px 16px;border-radius:25px;letter-spacing:0.8px;box-shadow:0 4px 20px rgba(124,58,237,0.4),0 2px 8px rgba(0,0,0,0.3),inset 0 1px 0 rgba(255,255,255,0.3);border:1px solid rgba(255,255,255,0.2);transform:translateY(0);transition:all 0.3s ease;z-index:1010}
.pricing-card.featured:hover::before{transform:translateY(-2px) scale(1.05);box-shadow:0 8px 30px rgba(124,58,237,0.6),0 4px 15px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.4);background:linear-gradient(135deg,rgba(88,28,135,1) 0%,rgba(124,58,237,0.9) 50%,rgba(139,92,246,1) 100%)}
.pricing-card.best-value::before{content:'BEST VALUE';position:absolute;top:-12px;right:20px;background:linear-gradient(135deg,rgba(88,28,135,0.9) 0%,rgba(124,58,237,0.8) 50%,rgba(139,92,246,0.9) 100%);backdrop-filter:blur(12px);color:#fff;font-size:11px;font-weight:800;padding:8px 16px;border-radius:25px;letter-spacing:0.8px;box-shadow:0 4px 20px rgba(124,58,237,0.4),0 2px 8px rgba(0,0,0,0.3),inset 0 1px 0 rgba(255,255,255,0.3);border:1px solid rgba(255,255,255,0.2);transform:translateY(0);transition:all 0.3s ease;z-index:1010}
.pricing-card.best-value:hover::before{transform:translateY(-2px) scale(1.05);box-shadow:0 8px 30px rgba(124,58,237,0.6),0 4px 15px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.4);background:linear-gradient(135deg,rgba(88,28,135,1) 0%,rgba(124,58,237,0.9) 50%,rgba(139,92,246,1) 100%)}
...
.plan-features{list-style:none;padding:0;margin:30px 0;position:relative;z-index:1001;flex-grow:1}
...
.plan-button{width:100%;background:linear-gradient(135deg,#9ca3af 0%,#d1d5db 100%);border:none;border-radius:0.5rem;padding:1rem 2.5rem;font-size:1.125rem;font-weight:600;color:#1f2937;cursor:pointer;transition:all 0.3s cubic-bezier(0.4,0,0.2,1);text-decoration:none;display:inline-block;text-align:center;position:relative;overflow:hidden;box-shadow:0 4px 15px rgba(107,114,128,0.2);margin-top:auto}
