...
.pricing-card.featured::before{content:'MOST POPULAR';position:absolute;top:-12px;right:20px;background:linear-gradient(135deg,rgba(100,116,139,0.9) 0%,rgba(148,163,184,0.8) 50%,rgba(203,213,225,0.9) 100%);backdrop-filter:blur(12px);color:#1e293b;font-size:11px;font-weight:800;padding:8px 16px;border-radius:12px;letter-spacing:0.8px;box-shadow:0 1px 4px rgba(0,0,0,0.08),inset 0 1px 0 rgba(255,255,255,0.4);border:1px solid rgba(255,255,255,0.3);transform:translateY(0);transition:all 0.3s ease;z-index:1010}
.pricing-card.featured:hover::before{transform:translateY(-2px) scale(1.05);box-shadow:0 2px 6px rgba(0,0,0,0.12),inset 0 1px 0 rgba(255,255,255,0.5);background:linear-gradient(135deg,rgba(71,85,105,1) 0%,rgba(100,116,139,0.9) 50%,rgba(148,163,184,1) 100%)}
.pricing-card.best-value::before{content:'BEST VALUE';position:absolute;top:-12px;right:20px;background:linear-gradient(135deg,rgba(100,116,139,0.9) 0%,rgba(148,163,184,0.8) 50%,rgba(203,213,225,0.9) 100%);backdrop-filter:blur(12px);color:#1e293b;font-size:11px;font-weight:800;padding:8px 16px;border-radius:12px;letter-spacing:0.8px;box-shadow:0 1px 4px rgba(0,0,0,0.08),inset 0 1px 0 rgba(255,255,255,0.4);border:1px solid rgba(255,255,255,0.3);transform:translateY(0);transition:all 0.3s ease;z-index:1010}
.pricing-card.best-value:hover::before{transform:translateY(-2px) scale(1.05);box-shadow:0 2px 6px rgba(0,0,0,0.12),inset 0 1px 0 rgba(255,255,255,0.5);background:linear-gradient(135deg,rgba(71,85,105,1) 0%,rgba(100,116,139,0.9) 50%,rgba(148,163,184,1) 100%)}
