...
.pricing-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:24px;margin:20px auto 60px auto;max-width:1400px;position:relative;z-index:1000;opacity:0;transform:translateY(30px) scale(0.95);transition:all 1.2s cubic-bezier(0.25,0.46,0.45,0.94);align-items:stretch;padding:0 40px;width:100%}
.pricing-grid.pricing-animated{opacity:1;transform:translateY(0) scale(1)}
.pricing-card{background:#0a0e1a;backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,0.1);border-radius:16px;padding:24px 28px;margin-bottom:20px;position:relative;z-index:1000;opacity:0;transform:translateY(30px) scale(0.95);transition:all 1.2s cubic-bezier(0.25,0.46,0.45,0.94);display:flex;flex-direction:column;height:100%;min-height:280px;width:100%}
...
.plan-name{color:#fff;font-size:1.5rem;font-weight:700;margin-bottom:8px;position:relative;padding-left:12px;z-index:1001}
...
.plan-price{font-size:2.7rem;font-weight:800;color:#9ca3af;margin-bottom:8px;position:relative;z-index:1001;padding-bottom:8px}
...
.plan-description{color:#cbd5e1;font-size:1.1rem;margin-bottom:8px;line-height:1.4;position:relative;z-index:1001}

.plan-features{list-style:none;padding:0;margin:8px 0;position:relative;z-index:1001;flex-grow:1}
.plan-features li{color:#cbd5e1;font-size:1rem;margin-bottom:4px;padding-left:18px;position:relative;line-height:1.3;z-index:1001}
.plan-features li::before{content:'→';position:absolute;left:0;color:#6b7280;font-weight:bold;z-index:1002}

.plan-button{width:100%;background:linear-gradient(135deg,#9ca3af 0%,#d1d5db 100%);border:none;border-radius:0.5rem;padding:0.9rem 1.6rem;font-size:1.1rem;font-weight:600;color:#1f2937;cursor:pointer;transition:all 0.3s cubic-bezier(0.4,0,0.2,1);text-decoration:none;display:inline-block;text-align:center;position:relative;overflow:hidden;box-shadow:0 4px 15px rgba(107,114,128,0.2);margin-top:auto}
...
.faq-answer-text strong{color:#1907B6;font-weight:700}
